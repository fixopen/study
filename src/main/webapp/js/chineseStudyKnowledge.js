...
//chineseStudyKnowledge-title
    let title = document.getElementById('title-template');
    let atitle = document.getElementById('chineseStudyKnowledge-title');
...
//chineseStudyKnowledge-section
    let section = document.getElementById('section-template');
    let asection = document.getElementById('chineseStudyKnowledge-section');
