...
public class Securities {
	...
	// ConfigManager.parseConfig("/data/program/tomcat/webapps/ROOT/WEB-INF/config.properties");
	public static final Config config = ConfigManager
			.parseConfig("E:\\supportNew\\trunk\\target\\support\\WEB-INF\\config.properties");
	// public static final Config config =
	// ConfigManager.parseConfig("/opt/apache-tomcat-8.0.23/webapps/ROOT/WEB-INF/config.properties");
}
